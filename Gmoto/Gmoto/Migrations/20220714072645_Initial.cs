        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PwHash = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: true),
                    Salt = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceTotal = table.Column<decimal>(type: "money", nullable: true),
                    DateOrdered = table.Column<DateTime>(type: "date", nullable: true),
                    Street = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true),
                    Zip = table.Column<int>(type: "int", nullable: true),
                    City = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true),
                    FirstName = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NetUnitPrice = table.Column<decimal>(type: "money", nullable: true),
                    TaxRate = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sizes = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true),
